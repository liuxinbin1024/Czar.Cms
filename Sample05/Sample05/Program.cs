...
namespace Sample05
{
    class Program
    {
        ...
        static void test_insert()
        {
            ...
            using (var conn = new SqlConnection("Data Source=WINDOWS-7131443;User ID=sa;Password=123456;Initial Catalog=Czar.Cms;Pooling=true;Max Pool Size=100;"))
            {
...
VALUES   (@title,@content,@status,@add_time,@modify_time)";
        ...
        static void test_del()
        {
            ...
            using (var conn = new SqlConnection("Data Source=127.0.0.1;User ID=sa;Password=123456;Initial Catalog=Czar.Cms;Pooling=true;Max Pool Size=100;"))
            {
